...
2. Clone the repo
   ```sh
   git clone https://github.com/sevleo/YoGato.git
   ```
...
See the [open issues](https://github.com/sevleo/YoGato/issues) for a full list of proposed features (and known issues).
